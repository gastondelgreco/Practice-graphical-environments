  ...
  if ($carro) {
    ...
    <table width="720" border="0" cellspacing="0" cellpadding="0" align="center">
      ...
      foreach ($carro as $k => $v) {
        ...
        $contador++;
        ?>
        <form name="a<?php echo $v['identificador'] ?>" method="post" action="agregarCarr.php?<?php echo SID ?>"
          ...
          <tr bgcolor="<?php echo $color[$contador % 2]; ?>" class='prod'>
            ...
            <td align="center"><a href="borraCarr.php?<?php echo SID ?>&id=<?php echo $v['id'] ?>"><img src="trash.gif"
    ...
    <div align="center"><span class="prod">Continuar la selección de productos</span>
      <a href="catalogo.php?<?php echo SID; ?>"><img src="continuar.gif" width="13" height="13" border="0"
          align="absmiddle"></a>&nbsp;
      <a href="regpago.php?<?php echo SID; ?>&costo=<?php echo $suma; ?>"><img src="finalizarcompra.gif" width="135"
          height="16" border="0" align="absmiddle"></a>
    </div>

  <?php } else { ?>
    <p align="center"> <span class="prod">No hay productos seleccionados</span> <a
        href="catalogo.php?<?php echo SID; ?>"><img src="continuar.gif" width="13" height="13" border="0"></a>
    <?php } ?>
  </p>
</body>
